...
{
    // 1. r�cup�re le code du vertex/fragment shader depuis filePath
    ...
    glLinkProgram(ID);
    // affiche les erreurs d'�dition de liens si besoin
    ...
    // supprime les shaders qui sont maintenant li�s dans le programme et qui ne sont plus n�cessaires
